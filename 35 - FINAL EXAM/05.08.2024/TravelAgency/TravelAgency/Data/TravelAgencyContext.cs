...
namespace TravelAgency.Data
{
    public class TravelAgencyContext : DbContext
    {
        private const string connectionString =
           "Server=.;Database= TravelAgencyDB ;User Id=sa;Password=Project123;TrustServerCertificate=true";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //    .HasKey(b => new { b.CustomerId, b.TourPackageId });

            modelBuilder.Entity<TourPackageGuide>()
                .HasKey(tp => new { tp.TourPackageId, tp.GuideId });
