...
namespace TravelAgency.Data
{
    public class TravelAgencyContext : DbContext
    {
        private const string connectionString =
                 "Server=.;Database= TravelAgencySB ;User Id=sa;Password=Project123;TrustServerCertificate=true";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Booking>()
                .HasKey(b => new { b.TourPackageId, b.CustomerId });
            modelBuilder.Entity<TourPackageGuide>()
                .HasKey(t => new { t.TourPackageId, t.GuideId });

            modelBuilder.Entity<Guide>().HasData(
                new Guide { Id = 1, FullName = "John Doe", Language = Models.Enums.Language.Russian },
                new Guide { Id = 2, FullName = "Jane Smith", Language = Models.Enums.Language.English },
                new Guide { Id = 3, FullName = "Alex Johnson", Language = Models.Enums.Language.Spanish },
                new Guide { Id = 4, FullName = "Emily Davis", Language = Models.Enums.Language.French },
                new Guide { Id = 5, FullName = "Michael Brown", Language = Models.Enums.Language.German },
                new Guide { Id = 6, FullName = "Sarah Wilson", Language = Models.Enums.Language.Russian },
                new Guide { Id = 7, FullName = "David Lee", Language = Models.Enums.Language.English },
                new Guide { Id = 8, FullName = "Laura Garcia", Language = Models.Enums.Language.German },
                new Guide { Id = 9, FullName = "Chris Martin", Language = Models.Enums.Language.Spanish },
                new Guide { Id = 10, FullName = "Anna Thompson", Language = Models.Enums.Language.French }
                );
